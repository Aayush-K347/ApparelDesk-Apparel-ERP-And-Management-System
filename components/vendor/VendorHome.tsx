...
const STAT_DATA = [
  ...
  { name: 'Invest', value: 2100, color: '#488C5C' },
    ...
    return (
        <div className="animate-[fadeIn_0.5s_ease-out]">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-6">
                ...
                <div className="xl:col-span-4 bg-[#488C5C] rounded-[32px] p-8 text-white relative overflow-hidden group shadow-xl shadow-[#488C5C]/20">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        ...
                        <div className="flex gap-4">
                            <button className="flex-1 bg-white text-[#488C5C] py-3 rounded-[16px] font-bold text-sm hover:bg-gray-100 transition-colors shadow-sm flex items-center justify-center gap-2">
                            ...
                            <div key={i} className="bg-[#F8F9FD] p-4 rounded-[20px]">
                                <div className="flex items-center gap-2 mb-3 text-gray-500">
                                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center shadow-sm">
                                        <stat.icon size={12} className="text-[#488C5C]" />
                                    </div>
                                    <span className="text-xs font-bold">{stat.label}</span>
                                </div>
                                <h4 className="font-bold text-sm mb-1">{stat.val}</h4>
                                <span className="text-[10px] font-bold text-[#488C5C] bg-[#488C5C]/10 px-1.5 py-0.5 rounded">{stat.change}</span>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full bg-gray-100 h-3 rounded-full overflow-hidden">
                            <div className="w-[92%] h-full bg-[#111111] rounded-full relative">
                                <div className="absolute right-0 top-0 bottom-0 w-20 bg-[#488C5C]"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-6">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="flex items-center gap-4">
                             <div className="flex items-center gap-2 text-xs font-bold">
                                 ...
                                 <span className="w-3 h-3 bg-[#488C5C] rounded-full ml-2"></span> Expense
                             </div>
                    ...
                    <div className="h-[250px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={CASHFLOW_DATA} barGap={8} barSize={12}>
                                ...
                                <Bar dataKey="expense" fill="#488C5C" radius={[4, 4, 4, 4]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                ...
                <div className="xl:col-span-5 bg-white rounded-[32px] p-8 shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col relative overflow-hidden">
                     ...
                     <div className="flex-1 flex flex-col items-center justify-center text-center mt-4">
                         <div className="w-20 h-20 bg-gradient-to-br from-[#488C5C] to-[#111111] rounded-full mb-6 shadow-lg shadow-green-900/20 animate-pulse"></div>
                     ...
                     <div className="bg-[#F8F9FD] rounded-[20px] p-2 flex items-center gap-2 mt-auto">
                         ...
                         <button className="bg-[#488C5C] text-white px-4 py-2 rounded-[14px] flex items-center gap-2 text-xs font-bold hover:bg-[#3a754b] transition-colors">
                             <Send size={14} /> Send
                         </button>
                     </div>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 bg-white rounded-[32px] p-8 shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-gray-100">
                    ...
                    <div className="space-y-6">
                        {[
                            { name: 'Dividend Payout', type: 'Investments', date: '2024-09-25 10:00', amount: '+$200.00', status: 'Completed', color: 'text-[#488C5C]' },
                            { name: 'Grocery Shopping', type: 'Food & Dining', date: '2024-09-24 14:30', amount: '-$154.20', status: 'Completed', color: 'text-red-500' },
                            { name: 'Freelance Payment', type: 'Income', date: '2024-09-23 15:00', amount: '+$850.00', status: 'Completed', color: 'text-[#488C5C]' },
                ...
                <div className="xl:col-span-3 bg-white rounded-[32px] p-8 shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-gray-100">
                    ...
                    <div className="flex justify-between text-xs font-bold text-gray-400 mb-8">
                         ...
                         <span className="text-[#488C5C]">Expense ($3,500)</span>
                    </div>
                ...
                <div className="xl:col-span-3 bg-white rounded-[32px] p-8 shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between gap-4 mb-8">
                        ...
                        <RefreshCw size={20} className="text-[#488C5C]" />
                        <div className="bg-gray-50 px-4 py-3 rounded-[16px] flex items-center gap-2 cursor-pointer border border-gray-100 flex-1 justify-center">
