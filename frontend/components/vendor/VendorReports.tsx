...
export const VendorReports: React.FC = () => {
    ...
    return (
        <div className="p-6 sm:p-12 h-full flex items-center justify-center animate-[fadeIn_0.5s_ease-out]">
            <div className="bg-white p-6 sm:p-12 rounded-xl shadow-lg border border-gray-100 w-full max-w-2xl">
                ...
                <div className="space-y-8">
                    <div className="grid grid-cols-1 sm:grid-cols-3 sm:items-center gap-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Report Type</label>
                        <select className="sm:col-span-2 border-b border-gray-200 py-2 bg-transparent text-sm focus:border-[#111111]">
                            <option>Sales</option>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 sm:items-center gap-2">
                        ...
                        <select
                          className="sm:col-span-2 border-b border-gray-200 py-2 bg-transparent text-sm focus:border-[#111111]"
                          value={groupBy}
                ...
                <div className="flex flex-col sm:flex-row sm:justify-end gap-3 mt-12 pt-6 border-t border-gray-100">
