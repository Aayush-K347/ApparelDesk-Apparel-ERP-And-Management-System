        ...
        <div className="p-8 h-full flex flex-col">
            ...
            <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-8">
                    <div className="group">
                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Product Name</label>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div className="group">
                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Gender</label>
                        ...
                        <div className="group">
                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Product Type</label>
                    ...
                    <div className="group">
                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Material</label>
                    ...
                    <div className="group">
                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Description</label>
                ...
                <div className="space-y-8 bg-gray-50 p-8 rounded-xl border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                         <div className="group">
                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Sales Price</label>
                        ...
                        <div className="group">
                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-2 group-focus-within:text-[#c3f235] transition-colors">Purchase Price</label>
                            <div className="flex items-center border-b border-gray-200 focus-within:border-[#111111] transition-colors">
                                <span className="text-gray-400">₹</span>
                    ...
                    <button type="submit" disabled={loading} className="w-full bg-[#111111] text-white py-4 rounded-lg text-xs font-bold uppercase tracking-[0.25em] hover:bg-[#c3f235] transition-colors disabled:opacity-60">
