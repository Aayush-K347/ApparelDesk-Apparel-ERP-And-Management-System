...
export const OrderSuccess: React.FC<OrderSuccessProps> = ({ setView }) => {
    ...
    return (
        <div className="min-h-screen bg-[#F2F4F3] flex items-center justify-center p-6 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#c9b52e] rounded-full blur-[150px] opacity-10 pointer-events-none"></div>
            ...
            <div className="w-full max-w-2xl bg-white p-12 md:p-16 text-center relative z-10 shadow-2xl rounded-[32px] border border-white/50 animate-[slideUp_0.8s_ease-out]">
                {/* Animated Checkmark */}
                <div className="w-24 h-24 bg-[#c9b52e] rounded-full flex items-center justify-center mx-auto mb-10 shadow-lg shadow-green-200 animate-[fadeIn_1s_ease-out]">
                    <Check size={48} className="text-white animate-[kenburns_0.5s_ease-in]" strokeWidth={3} />
                </div>

                <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#c9b52e] mb-4">Payment Successful</h2>
                ...
                <div className="flex flex-col md:flex-row justify-center gap-4">
                    <button 
                        ...
                        className="bg-[#111111] text-white px-8 py-4 font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#c9b52e] transition-colors shadow-lg flex items-center justify-center gap-2 group"
                    >
