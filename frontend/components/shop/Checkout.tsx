                            ...
                            {step === 'SHIPPING' && (
                                <div className="mt-8 flex justify-end">
                                    <button 
                                        ...
                                        className="bg-[#111111] text-white px-8 py-4 font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#c9b52e] transition-colors shadow-lg"
                                    >
                                        Continue to Payment
                                    </button>
                                </div>
                            ...
                            <form onSubmit={handleProcessPayment}>
                                ...
                                <div className="mt-8 flex justify-between items-center">
                                    ...
                                    <button 
                                        ...
                                        className="bg-[#111111] text-white px-10 py-4 font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#c9b52e] transition-colors shadow-lg flex items-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
                                        {isProcessing ? (
                                            <>
                ...
                <div className="lg:col-span-5">
                    <div className="sticky top-32 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-white p-4 border border-gray-100 flex items-center gap-3">
                                <Truck className="text-[#c9b52e]" size={20} />
                                <div>
