             ...
             <div className="max-w-7xl mx-auto px-6 md:px-12">
                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
                     ...
                     <div className="flex flex-col justify-center animate-[fadeIn_0.5s_ease-out_0.2s_forwards] opacity-0">
                         <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#c9b52e] mb-2">{selectedProduct.gender} / {selectedProduct.category}</span>
                         ...
                         <button 
                            ...
                            className="w-full bg-[#111111] text-white py-5 font-bold uppercase tracking-[0.25em] text-xs hover:bg-[#c9b52e] transition-colors shadow-xl mb-6"
                        >
                             Add to Cart
                         </button>
                         ...
                         <div className="bg-white p-6 border border-gray-100 space-y-4">
                             <div className="flex gap-3 items-start">
                                 <Truck size={18} className="text-[#c9b52e] mt-0.5" />
                                 <div>
                             ...
                             <div className="flex gap-3 items-start">
                                 <ShieldCheck size={18} className="text-[#c9b52e] mt-0.5" />
                                 <div>
                 ...
                 {relatedProducts.length > 0 && (
                     <div className="border-t border-gray-200 pt-16">
                         <div className="flex items-center gap-4 mb-10">
                            <span className="h-[1px] w-12 bg-[#c9b52e]"></span>
                            <span className="text-[10px] font-bold tracking-[0.4em] text-[#c9b52e] uppercase">You May Also Like</span>
                        </div>
