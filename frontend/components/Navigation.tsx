    ...
    <>
      ...
      >
        ...
        <div className="flex gap-5 md:gap-8 items-center">
           <a href="https://appareldesk-apparel-erp-and-management-k34j.onrender.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#c9b52e] transition-colors relative group py-2">
