      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 md:gap-24">
        ...
        <div className="flex-1">
            ...
            <div className="flex gap-4">
                <Facebook size={18} className="hover:text-[#c3f235] transition-colors cursor-pointer" />
                <Instagram size={18} className="hover:text-[#c3f235] transition-colors cursor-pointer" />
                <Twitter size={18} className="hover:text-[#c3f235] transition-colors cursor-pointer" />
            </div>
        </div>
