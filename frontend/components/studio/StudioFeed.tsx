    ...
    return (
        <div className="min-h-screen bg-[#F2F4F3] bg-subtle-grid pb-32 relative">
            ...
            <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
                 <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#c9b52e]/5 rounded-full blur-[150px]"></div>
            ...
            <div className="relative pt-32 pb-16 text-center px-6 z-10">
                 <div className="inline-flex items-center gap-2 mb-8 px-4 py-1.5 border border-[#111111]/10 rounded-full bg-white/60 backdrop-blur-md shadow-sm">
                     <span className="relative flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#c9b52e] opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-[#c9b52e]"></span>
                     </span>
                ...
                <div className="container mx-auto px-6 overflow-x-auto no-scrollbar flex justify-center gap-2 md:gap-4">
                     {[
                         ...
                         <button
                            ...
                            `}
                         >
                             <filter.icon size={12} className={activeFilter === filter.id ? 'text-[#c9b52e]' : ''} />
            ...
            <div className="relative z-20 mt-24 text-center pb-24">
                ...
                <button className="border-b border-[#111111] pb-1 text-[10px] font-bold uppercase tracking-[0.2em] hover:text-[#c9b52e] hover:border-[#c9b52e] transition-colors">
