                         ...
                         <div className="flex items-center gap-2 backdrop-blur-md bg-black/20 p-1.5 rounded-full pr-4 border border-white/10">
                            ...
                            <div className="flex flex-col">
                                <span className="text-white font-bold text-[10px] tracking-wide flex items-center gap-1">
                                    {post.creator.name}
                                    {post.creator.isVerified && <BadgeCheck size={10} className="text-[#c9b52e] fill-white" />}
                                </span>
                            </div>
                         </div>
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 z-20 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                        ...
                        <div className="flex justify-between items-end">
                            ...
                            <button 
                                ...
                                className="bg-white text-[#111111] pl-3 pr-4 py-2 rounded-full flex items-center gap-2 hover:bg-[#c9b52e] hover:text-white transition-all duration-300 shadow-lg group/btn"
                            >
                                <div className="bg-[#111111] text-white rounded-full p-1 group-hover/btn:bg-white group-hover/btn:text-[#c9b52e] transition-colors">
                                    <ShoppingBag size={12} />
                                </div>
                ...
                >
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col justify-center">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <ArrowRight size={16} className="text-gray-300 -rotate-45 group-hover/item:rotate-0 group-hover/item:text-[#c9b52e] transition-all" />
                                    </div>
                    ...
                    <div className="p-6 bg-white border-t border-gray-200">
                         <button 
                            ...
                            className="w-full bg-[#111111] text-white py-4 rounded-xl text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#c9b52e] transition-colors shadow-lg"
                        >
                             View All Products
                         </button>
                    </div>
